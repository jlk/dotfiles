# Generated by Powerlevel10k configuration wizard on 2020-01-22 at 23:38 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    #jlk kubecontext             # current kubernetes context (https://kubernetes.io/)
  ...
  #jlktypeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,SUDO}_{CONTENT,VISUAL_IDENTIFIER}_EXPANSION=
